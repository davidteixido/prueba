...
//	$mensaje = wordwrap($mensaje, 70, "\r\n");
	...
	$destinatario_seccion_contacto = "dteixido@gmail.com";
	$destinatario_piennsa = "dteixido@gmail.com";
...
$msj .= "Su opinion: <strong>".$opinion."</strong><br/>";
...
$_mail = new PHPMailer();
    ...
    $_mail->From = 'info@piennsa.com';
    $_mail->FromName = 'piennsa | digital business';
    $_mail->Subject = 'Nuevo contacto desde la web';
    $_mail->Body = $msj;
    //$_mail->IsSMTP();
    $_mail->IsHTML (true);
